...
const data = [
    ...
    {
        name: "Hilly Hilly",
        image: "https://s27363.pcdn.co/wp-content/uploads/2016/01/Julie-Rivenbark-on-Trolltunga-1163x775.jpg.optimal.jpg",
        description: "This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action."
    },
    {
        name: "Glaciers",
    ...
    {
        name: "Ladakh",
        image: "https://wallup.net/wp-content/uploads/2016/01/36052-nature-sunset-landscape-camping.jpg",
        description: "This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action."
    },
    {
        name: "Himalaya",
    ...
    {
        name: "Hilly Hilly",
        image: "https://www.yellowstonepark.com/.image/t_share/MTcwMDQ4NjM4Njk1Nzc3ODY1/thermopolis-hotspringsstatepark_courtesy_940.jpg",
        description: "This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action."
    },
    {
        name: "Ladakh",
